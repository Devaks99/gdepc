...
function setupThemeToggle() {
    ...
    // Event listeners para toggle de tema
    if (themeToggle) {
    ...
    function updateThemeIcons(theme) {
        ...
        if (mobileThemeIcon) {
            mobileThemeIcon.innerHTML = theme === 'dark' ? sunIcon : moonIcon;
        }
    }
}
...
async function loadFlashcards() {
    try {
        ...
        allFlashcards = getExampleFlashcards();
        filteredFlashcards = [...allFlashcards];
        displayFlashcards();
        updateCardCounter();
    }
...
function getExampleFlashcards() {
    return [
    {
        "id": 1,
        "category": "conhecimentos-gerais",
        "question": "O que é o Estado Democrático de Direito?",
        "answer": "É um sistema político onde o poder emana do povo e é exercido através de representantes eleitos, com respeito às leis e aos direitos fundamentais dos cidadãos. Caracteriza-se pela separação dos poderes, supremacia da Constituição e garantia dos direitos humanos."
    },
    {
        "id": 2,
        "category": "conhecimentos-gerais",
        "question": "Quais são os princípios da Administração Pública?",
        "answer": "Os princípios constitucionais da Administração Pública são: Legalidade (agir conforme a lei), Impessoalidade (tratamento igual), Moralidade (ética), Publicidade (transparência) e Eficiência (otimização de recursos) - LIMPE."
    },
    {
        "id": 3,
        "category": "conhecimentos-gerais",
        "question": "O que é Ética no Serviço Público?",
        "answer": "É o conjunto de princípios morais que devem orientar a conduta dos servidores públicos, priorizando o interesse público sobre o privado, com probidade, honestidade, transparência e responsabilidade social."
    },
    {
        "id": 4,
        "category": "conhecimentos-gerais",
        "question": "O que são Políticas Públicas?",
        "answer": "São ações e programas desenvolvidos pelo Estado para resolver problemas públicos e atender às necessidades da sociedade, envolvendo planejamento, implementação, monitoramento e avaliação de resultados."
    },
    {
        "id": 5,
        "category": "conhecimentos-gerais",
        "question": "O que é Diversidade e Inclusão no contexto público?",
        "answer": "Refere-se à promoção da igualdade de oportunidades e respeito às diferenças (gênero, raça, orientação sexual, deficiência), garantindo participação plena de todos os grupos sociais na administração pública."
    },
    {
        "id": 6,
        "category": "conhecimentos-especificos",
        "question": "O que é Ciência, Tecnologia e Sociedade (CTS)?",
        "answer": "É um campo interdisciplinar que estuda as relações entre ciência, tecnologia e sociedade, analisando como elas se influenciam mutuamente e os impactos sociais, econômicos e ambientais do desenvolvimento científico-tecnológico."
    },
    {
        "id": 7,
        "category": "conhecimentos-especificos",
        "question": "O que são Políticas de CT&I?",
        "answer": "São políticas públicas voltadas para Ciência, Tecnologia e Inovação, que visam promover o desenvolvimento científico e tecnológico do país através de investimentos, incentivos e marcos regulatórios adequados."
    },
    {
        "id": 8,
        "category": "conhecimentos-especificos",
        "question": "O que é Gestão de Projetos?",
        "answer": "É a aplicação de conhecimentos, habilidades, ferramentas e técnicas para executar projetos de forma eficaz e eficiente, envolvendo iniciação, planejamento, execução, monitoramento e encerramento."
    },
    {
        "id": 9,
        "category": "conhecimentos-especificos",
        "question": "O que são TICs (Tecnologias da Informação e Comunicação)?",
        "answer": "São tecnologias que permitem o processamento, armazenamento e transmissão de informações de forma digital, incluindo computadores, internet, software, telecomunicações e sistemas de informação."
    },
    {
        "id": 10,
        "category": "conhecimentos-especificos",
        "question": "O que é Metodologia Científica?",
        "answer": "É o conjunto de métodos e técnicas utilizados para conduzir pesquisas científicas de forma sistemática, objetiva e rigorosa, garantindo a validade e confiabilidade dos resultados obtidos."
    },
    {
        "id": 11,
        "category": "conhecimentos-gerais",
        "question": "O que é a Realidade Brasileira no contexto do CNU?",
        "answer": "Refere-se ao conhecimento sobre aspectos sociais, econômicos, políticos e culturais do Brasil contemporâneo, incluindo desigualdades, diversidade regional, desafios de desenvolvimento e características da sociedade brasileira."
    },
    {
        "id": 12,
        "category": "conhecimentos-especificos",
        "question": "O que é Inovação Tecnológica?",
        "answer": "É o processo de criação, desenvolvimento e implementação de novas tecnologias, produtos ou processos que geram valor econômico e social, contribuindo para o avanço científico e competitividade."
    },
    {
        "id": 13,
        "category": "conhecimentos-gerais",
    ...
    },
    {
        "id": 44,
        "category": "conhecimentos-especificos",
        "question": "Qual a função do SISP (Sistema de Administração dos Recursos de TI) no governo federal?",
...
// Configurar filtros de flashcards
...
function displayFlashcards() {
    ...
    if (!container || filteredFlashcards.length === 0) return;

    const currentCard = filteredFlashcards[currentFlashcardIndex];
    if (!currentCard) return;

    container.innerHTML = `
        <div class="flashcard bg-white rounded-xl shadow-lg p-6 cursor-pointer transition-all duration-300 hover:shadow-xl col-span-full" onclick="flipCard(this)">
            <div class="flashcard-inner">
                <div class="flashcard-front">
                    <div class="flex justify-between items-start mb-4">
                        <span class="category-tag ${currentCard.category} px-3 py-1 rounded-full text-sm font-medium">
                            ${currentCard.category === 'conhecimentos-gerais' ? 'Conhecimentos Gerais' : 'Conhecimentos Específicos'}
                        </span>
                        <span class="text-gray-400 text-sm">Clique para ver a resposta</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Pergunta:</h3>
                    <p class="text-gray-600 text-lg leading-relaxed">${currentCard.question}</p>
                </div>
                <div class="flashcard-back hidden">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="text-gray-400 text-sm">Clique para ver a pergunta</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Resposta:</h3>
                    <p class="text-gray-600 text-lg leading-relaxed">${currentCard.answer}</p>
                </div>
            </div>
        </div>
    `;
...
// Configurar navegação de flashcards
...
function updateCardCounter() {
    ...
    if (counter && filteredFlashcards.length > 0) {
        counter.textContent = `${currentFlashcardIndex + 1} de ${filteredFlashcards.length}`;
    }
    ...
    if (nextBtn) {
        nextBtn.disabled = currentFlashcardIndex === filteredFlashcards.length - 1;
    }
}
